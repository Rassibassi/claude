...
def calcInterChannelNLIN(chi,kur,P0,PolMux,dtype=tf.float64):
...
def calcInterChannelNLINAddTerms(X,kur,P0,PolMux,dtype=tf.float64):
    c = tfConstants(dtype=dtype)
...
def calcIntraChannelNLIN(X,kur,kur3,P0,PolMux,dtype=tf.float64):
    c = tfConstants(dtype=dtype)
...
def calcInterChannelGN(chi,P0,PolMux,dtype=tf.float64):
    c = tfConstants(dtype=dtype)
...
def calcIntraChannelGN(X,P0,PolMux,dtype=tf.float64):
    c = tfConstants(dtype=dtype)
