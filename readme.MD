...
|iPython Notebook Example | Channel | Optimised for bits/symbols (GMI/MI) | Gradient Through Channel | Reference |
|---|---|---|---|---|
...
[Link](examples/tf_wdmSystem-learning.ipynb) | Fiber (SSFM)| Symbols (MI) | :heavy_check_mark: | ---
